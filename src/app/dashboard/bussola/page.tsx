                    ...
                    <section className="lg:col-span-8 bg-[#fffdf8]/90 border border-[#e4e0d7] rounded-[24px] p-6 shadow-sm min-w-0 flex flex-col">
                        ...
                        <div className="block sm:hidden divide-y divide-[#efebe2] border border-[#e4e0d7] rounded-2xl bg-white shadow-xs overflow-hidden">
                            {activeAssets.map((asset) => (
                                <div key={asset.assetName} className="px-4 py-3.5 flex items-center justify-between gap-3 hover:bg-[#fbfaf8] transition-colors">
                                    <div className="min-w-0 flex-1">
                                        <div className="font-bold text-[#123044] text-[13.5px] leading-snug break-words">
                                            {asset.assetName}
                                        </div>
                                    ...
                                    <div className="shrink-0 text-right">
                                        <span className="inline-flex items-center justify-center min-w-[54px] px-2.5 py-1.5 rounded-lg bg-[#e8f1ed] text-[#1f674f] text-xs font-black shadow-2xs">
